...
#    endif
    ...
    void CodegenX86::emit_base_refresh()
    {
        ...
        e_.mov32(kScratchB, mem(kScratchA, kScratchB, kCallFrameHalfScale, CallFrame::base_offset() - kCallFrameStride));
        ...
        switch (op.kind)
        {
            ...
            case CgOpKind::kLoadFramePc:
                ...
                if (!failed_)
                {
                    ...
                    e_.lea(kScratchA, mem(kScratchA, kScratchB, kCallFrameHalfScale));
                    e_.mov32(
                        gp(op.var), mem(kScratchA, kScratchB, kCallFrameHalfScale, CallFrame::pc_offset() - kCallFrameStride));
                    if constexpr (!kMode64)
                    {
