...
namespace behl
{
    ...
    std::string instruction_to_string(const Instruction& instr, [[maybe_unused]] size_t pc)
    {
        ...
        {
            case OpCode::kOpMove:
                opcode_str = behl::format("{:<9} R{} R{}", meta.name, instr.a(), instr.b());
                break;
            case OpCode::kOpLoadS:
                opcode_str = behl::format("{:<9} R{} K{}", meta.name, instr.a(), instr.const_or_proto_index());
                break;
            ...
            case OpCode::kOpGetUpval:
                opcode_str = behl::format("{:<9} R{} U{}", meta.name, instr.a(), instr.b());
                break;
            ...
            {
                opcode_str = behl::format("{:<9} R{} R{} {}", meta.name, instr.a(), instr.b(), instr.small_const_index());
                break;
            }
            case OpCode::kOpGetFieldS:
            {
                opcode_str = behl::format("{:<9} R{} R{} K{}", meta.name, instr.a(), instr.b(), instr.small_const_index());
                break;
            }
            case OpCode::kOpSetUpval:
                opcode_str = behl::format("{:<9} U{} R{}", meta.name, instr.b(), instr.a());
                break;
            case OpCode::kOpSetGlobal:
                opcode_str = behl::format("{:<9} K{} R{}", meta.name, instr.const_or_proto_index(), instr.a());
                break;
            ...
            case OpCode::kOpNewTable:
                opcode_str = behl::format("{:<9} R{} {} {}", meta.name, instr.a(), instr.b(), instr.c());
                break;
            case OpCode::kOpSelf:
                opcode_str = behl::format("{:<9} R{} R{} R{}", meta.name, instr.a(), instr.b(), instr.c());
                break;
            ...
            case OpCode::kOpAddImm:
                opcode_str = behl::format("{:<9} R{} R{} {}", meta.name, instr.a(), instr.b(), instr.signed_immediate_9bit());
                break;
            ...
            case OpCode::kOpIncGlobal:
                opcode_str = behl::format("{:<9} K{}", meta.name, instr.large_const_index());
                break;
            ...
            case OpCode::kOpTestSet:
                opcode_str = behl::format(
                    "{:<9} R{} R{} {}", meta.name, instr.a(), instr.b(), (instr.c() ? "invert" : "normal"));
                break;
            case OpCode::kOpCall:
                opcode_str = behl::format("{:<9} R{} {} {}", meta.name, instr.a(), instr.b(), instr.c());
                break;
            ...
            case OpCode::kOpClosure:
                opcode_str = behl::format("{:<9} R{} P{}", meta.name, instr.a(), instr.const_or_proto_index());
                break;
